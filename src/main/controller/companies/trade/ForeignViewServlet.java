...
@WebServlet(name = "ForeignView", urlPatterns = "/view/foreign")
public class ForeignViewServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        DbResult<ForeignCompany> company = Database.getInstance().getForeign(id);
        ...
        if (company.isAnyError()) {
            ...
            DbResult<List<FullTrade>> exports = Database.getInstance().getFullTradesForForeignInPeriod(id, TradeType.EXPORT, from, to);
